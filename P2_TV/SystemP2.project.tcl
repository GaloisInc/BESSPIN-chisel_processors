...
#
# SystemP2.project.tcl: Tcl script for re-creating project 'project_P2_1'
#
# Generated by Vivado on Thu Jan 31 14:30:17 PST 2019
...
#
# 1. This project restoration tcl script (SystemP2.project.tcl) that was generated.
#
...
#
#    "/home/gdimou/git_wd/chisel_processors/P2/src/AsyncResetReg.v"
#    "/home/gdimou/git_wd/chisel_processors/P2/src/galois.system.P2TVFPGAConfig.behav_srams.v"
#    "/home/gdimou/git_wd/chisel_processors/P2/src/plusarg_reader.v"
#    "/home/gdimou/git_wd/chisel_processors/P2/src/galois.system.P2TVFPGAConfig.v"
#    "/home/gdimou/xilinx_scratch/project_P2_1/project_P2_1.srcs/constrs_1/new/P2.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "project_P2_1"
...
set script_file "SystemP2.project.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../xilinx_scratch/project_P2_1"]"
...
set_property -name "compxlib.xcelium_compiled_library_dir" -value "/home/gdimou/xilinx_scratch/project_4/project_4.cache/compile_simlib/xcelium" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../xilinx_scratch/ip_test1"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/src/AsyncResetReg.v"] \
 [file normalize "${origin_dir}/src/galois.system.P2TVFPGAConfig.behav_srams.v"] \
 [file normalize "${origin_dir}/src/plusarg_reader.v"] \
 [file normalize "${origin_dir}/src/galois.system.P2TVFPGAConfig.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "P2System" -objects $obj
...
set file "[file normalize ${origin_dir}/../../../xilinx_scratch/project_P2_1/project_P2_1.srcs/constrs_1/new/P2.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../../xilinx_scratch/project_P2_1/project_P2_1.srcs/constrs_1/new/P2.xdc"
...
set_property -name "top" -value "TestHarness" -objects $obj
...
set_property -name "steps.synth_design.args.fanout_limit" -value "1000" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcvu9p-flga2104-2L-e -flow {Vivado Implementation 2017} -strategy "Performance_RefinePlacement" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "steps.route_design.args.directive" -value "AdvancedSkewModeling" -objects $obj
